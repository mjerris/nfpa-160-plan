...
|---|---|---|---|
| Written start-up procedures | Yes | [6.2.1] | |
...
| Field | Required | Section | Guidance |
|---|---|---|---|
| Plan for maintaining premises in neat and orderly condition | Yes | [7.2] | |

## 5.8 Protective Clothing

| Field | Required | Section | Guidance |
|---|---|---|---|
| Description of protection for operators, performers, and assistants (clothing or other means suitable for exposure) | Yes | [7.10.1] | |
| If bare skin is part of the effect: documentation that illusion of danger is implicit in the visual effect | Conditional | [7.10.2] | |
